const documentBreakPoint = [600,412, 375]
 ...
 if(document.documentElement.clientWidth < documentBreakPoint[0])
 {
    dropdown1 = () =>{
      ...
      arrowDom[0].style.marginBottom = "10px";
      ...
      In C# the data type that is being store in a variable is specify upon the variable declaration</p> `;
